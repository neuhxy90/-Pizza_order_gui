...
s=Tk()
s.title('Mano\'s Pizzo Order System')
s.geometry("1376x900")
...
class Login:
    def __init__(sf):
        ...
        sf.f.place(x=0,y=0,width=1376,height=900)
    ...
    def register(sf):
        ...
        #   CANVAS  for image
        sf.canvas=Canvas(sf.f,bg='PeachPuff',bd=-2)
        sf.canvas.place(x=0,y=0,width=1376,height=850)  # previous height=125 
        sf.img=ImageTk.PhotoImage(Image.open('img/background.jpg'))
        sf.canvas.create_image(681,405,image=sf.img)
        sf.l.append(sf.canvas)
    ...
    def create_order(sf,val):
        ...
        sf.pizza_logo=PhotoImage(file='img/pizza_logo.png')  ## pizza logo  ##
        ...
        sf.drinks_logo=PhotoImage(file='img/drinks_logo.png')  ## drinks logo ##
        ...
        sf.meals_logo=ImageTk.PhotoImage(Image.open('img/meals_logo.jpg'))  ## meals logo ##
        ...
        sf.cart=PhotoImage(file='img/cart2.png')                                                 ## cart logo ##
        ...
        sf.img=ImageTk.PhotoImage(Image.open('img/Margherita.jpg'))
        ...
        sf.img2=ImageTk.PhotoImage(Image.open('img/Double_Cheese_Margherita.jpg'))
        ...
        sf.img3=ImageTk.PhotoImage(Image.open('img/Farmhouse.jpg'))
        ...
        sf.img4=ImageTk.PhotoImage(Image.open('img/Peppy_Paneer.jpg'))
        ...
        sf.img5=ImageTk.PhotoImage(Image.open('img/Mexican_Green_Wave.jpg'))
        ...
        sf.img6=ImageTk.PhotoImage(Image.open('img/Deluxe_Veggie.jpg'))
        ...
        sf.img7=ImageTk.PhotoImage(Image.open('img/5_Pepper.jpg'))
        ...
        sf.img8=ImageTk.PhotoImage(Image.open('img/Veg_Extravaganza.jpg'))
        ...
        sf.img9=ImageTk.PhotoImage(Image.open('img/Cheese_&_Corn.jpg'))
        ...
        sf.img10=ImageTk.PhotoImage(Image.open('img/Paneer_Makhni.jpg'))
        ...
        sf.img11=ImageTk.PhotoImage(Image.open('img/Veggie_Paradise.jpg'))
        ...
        sf.img12=ImageTk.PhotoImage(Image.open('img/Fresh_Veggie.jpg'))
    ...
    def meals(sf,val):
        if sf.P['R']==0 and sf.P['M']==0 and sf.P['L']==0:
            ...
            sf.meal1=ImageTk.PhotoImage(Image.open('img/meal1.jpg'))   ## meal 1 ##
            ...
            sf.meal2=ImageTk.PhotoImage(Image.open('img/meal2.jpg'))  ## meal 2 ##
            ...
            sf.meal3=ImageTk.PhotoImage(Image.open('img/meal3.jpg'))  ## meal 3 ##
            ...
            sf.meal4=ImageTk.PhotoImage(Image.open('img/meal4.jpg'))  # bruchetta salmon
    ...
    def drinks(sf,val):
        if sf.TOTAL==-1:  ## was too lazy to reindent the else block............so a bogus condition here !!!
            ...
            sf.coke=ImageTk.PhotoImage(Image.open('img/coca_cola.jpg')) ####    COKE 1  ####
            ...
            sf.pepsi=PhotoImage(file='img/pepsi.png')                   ####    PEPSI 2  ####
            ...
            sf.sprite=PhotoImage(file='img/sprite.png')                 ####    SPRITE 3 ####
            ...
            sf.mtn=ImageTk.PhotoImage(Image.open('img/mtn2.jpg'))       ####    DEW 4  ####
            ...
            sf.fanta=ImageTk.PhotoImage(Image.open('img/fanta.jpg'))    ####    FANTA 5 ####
            ...
            sf.thums=ImageTk.PhotoImage(Image.open('img/thums_up.jpg'))   ####    THUMS UP 6 ####
    ...
    def payment_window(sf,val):  #####       Payment window       #####
        if(sf.P['R']==0 and sf.P['M']==0 and sf.P['L']==0):
            ...
            sf.loc=PhotoImage(file='img/loc.png')
            ...
            sf.pizza_logo2=PhotoImage(file='img/pizza_logo2.png')
            sf.drinks_logo2=PhotoImage(file='img/drinks_logo2.png')
            sf.meals_logo2=ImageTk.PhotoImage(Image.open('img/meals_logo2.jpg'))
            for p in sf.dict:
